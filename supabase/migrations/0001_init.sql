-- LOCAL DEV ONLY — inclui "user" (criada pelo Better-Auth em prod).
-- Roda via: docker exec -i masia_local_db_appointment-hub psql -U masia -d tenant_local < supabase/migrations/0001_init.sql
